...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Build a file classification dataset from the matched budget workfile."
    )
    parser.add_argument(
        "--workfile",
        type=Path,
        default=DEFAULT_WORKFILE,
        help="Path to matched workfile (.xlsx, .csv, or .tsv).",
    )
    parser.add_argument(
        "--sheet-name",
    ...
    parser.add_argument(
        ...
        help="Label mapping CSV output path.",
    )
    parser.add_argument(
        "--summary-json",
        type=Path,
    ...
    parser.add_argument(
        ...
        help="Unresolved rows CSV output path.",
    )
    parser.add_argument(
        "--extensions",
        nargs="+",
